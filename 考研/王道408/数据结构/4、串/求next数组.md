...
> next 数组是 [[考研/王道408/数据结构/4、串/KMP算法]] 的灵魂。手工求 next 是 408 选择题的**必考题型**（给一个模式串，求 next 或 nextval）；代码级求法（`get_next`）也常出现在大题中。掌握"**递推思想 + 手工三步法**"两条路线即可满分拿下。
...
- [[考研/王道408/数据结构/4、串/KMP算法]]：next 数组的使用者
- [[考研/王道408/数据结构/4、串/KMP算法的进一步优化]]：由 next 递推 nextval
- [[考研/王道408/数据结构/4、串/朴素模式匹配算法]]：为什么需要 next 的对比背景
...
- [[考研/王道408/数据结构/4、串/KMP算法]]：next[j] = 失配时 j 的跳转位置
- [[考研/王道408/数据结构/4、串/KMP算法的进一步优化]]：nextval = 修正后的 next
- [[考研/王道408/数据结构/4、串/朴素模式匹配算法]]：没有 next 的暴力版本
- [[考研/王道408/数据结构/4、串/串的存储结构]]：`ch[0]` 闲置、下标从 1